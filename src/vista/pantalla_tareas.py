...
################################################################################
## Form generated from reading UI file 'pantalla_tareas.ui'
##
...
class AppTareasPendientes(object):
    def setupUi(self, AppTareasPendientes):
        ...
        AppTareasPendientes.resize(419, 303)
...
"")
        ...
        self.boton_agregar_tarea.setIcon(icon)
        ...
        self.boton_eliminar_tarea.setIcon(icon1)
    ...
    def retranslateUi(self, AppTareasPendientes):
        AppTareasPendientes.setWindowTitle(QCoreApplication.translate("AppTareasPendientes", u"App Tareas", None))
        ...
        self.boton_tarea_completada.setText(QCoreApplication.translate("AppTareasPendientes", u"Marcar/Desmarcar", None))
        self.boton_eliminar_tarea.setText(QCoreApplication.translate("AppTareasPendientes", u"Eliminar tarea marcada", None))
    # retranslateUi
